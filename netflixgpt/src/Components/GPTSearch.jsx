...
const handleSearchClick = async () => {
  ...
  return (
    <div className="flex  m-8 my-14  sm:mx-48   ">
      ...
      <input
        ...
        className="search bg-slate-800 h-14 w-52 md:w-72  lg:w-[44rem] px-3  outline-none text-slate-200 text-lg"
        ref={search_input}
      ></input>

      <button
        className="h-14  w-20 sm:w-32    rounded-r-lg bg-red-700 text-slate-100 text-xl"
